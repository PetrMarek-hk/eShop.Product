...
internal static class UpdateProductExtensions
{
    ...
    //}
    public static IProductResponse ToProductResponse(this IUpdateProductResponseMsg responseMessage, IMapper mapper)
    {
